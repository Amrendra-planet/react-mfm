...
**Quickstart**: after cloning clientServer, cd into clientServer, do `npm install`, cd into src, do `npm start`, and localhost:3000 should open in your browser. There, you can log in with google or sign up and create a new email login.
